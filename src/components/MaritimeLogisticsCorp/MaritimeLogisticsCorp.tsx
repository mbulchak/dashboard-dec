...
export const MaritimeLogisticsCorp = () => {
  return (
    <>
      <div className='flex flex-col-reverse 2xl:flex-row 2xl:items-end gap-x-[55px] gap-y-[15px] mb-[24px]'>
        <div className='flex items-center gap-x-[13px]'>
          <img src={logoMaritimeCorp} alt='logo Maritime Corp' className='h-[77px] w-[77px] cursor-pointer' />

          <div className='flex flex-col'>
            <h3 className='text-[24px]'>Maritime Logistics Corp</h3>

            <div className='grid grid-cols-[250px_180px] md:grid-cols-[250px_180px_150px] lg:grid-cols-[250px_180px_150px_150px] gap-x-[15px] gap-y-[5px]'>
              <div className='pe-[10px] border-r border-[#313b54]'>
                425 Harbor Boulevard, Suite 300
                <p>Seattle,WA 98104</p>
              </div>

              <section className='pe-[10px] md:border-r border-[#313b54]'>
